use crate::xhc::registers::internal::runtime_registers::interrupter_register_set::interrupter_management_register::interrupt_enable::InterruptEnable;
use crate::xhc::registers::internal::runtime_registers::interrupter_register_set::interrupter_management_register::interrupt_pending::InterruptPending;
