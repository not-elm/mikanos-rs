...
use crate::xhc::registers::capability_registers::structural_parameters1::number_of_ports::NumberOfPorts;
use crate::xhc::registers::capability_registers::structural_parameters1::structural_parameters1_field::StructuralParameters1Field;
