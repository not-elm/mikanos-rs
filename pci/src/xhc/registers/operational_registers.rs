...
use crate::xhc::registers::operational_registers::command_ring_control_register::{
    CommandRingControlRegister, CommandRingControlRegisterOffset,
};
use crate::xhc::registers::operational_registers::config_register::{
    ConfigRegister, ConfigRegisterOffset,
};
use crate::xhc::registers::operational_registers::device_context_base_address_array_pointer::{
    DeviceContextBaseAddressArrayPointer, DeviceContextBaseAddressArrayPointerOffset,
};
...
use crate::xhc::registers::operational_registers::usb_command_register::UsbCommandRegister;
...
use crate::xhc::registers::operational_registers::usb_status_register::UsbStatusRegister;
