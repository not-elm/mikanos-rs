...
pub(crate) fn setup_event_ring(
    registers: &mut impl InterrupterSetRegisterAccessible,
    ...
    registers.write_event_ring_segment_table_size(0, event_ring_segment_table_size)?;
    registers.write_event_ring_dequeue_pointer(0, event_ring_segment_addr)?;
    ...
    registers.write_event_ring_segment_table_pointer(0, event_ring_segment_table_addr)?;
