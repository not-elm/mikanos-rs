use pci::xhc::registers::internal::operational_registers::usb_status_register::host_controller_halted::HostControllerHalted;
use pci::xhc::registers::internal::operational_registers::usb_status_register::usb_status_register_field::UsbStatusRegisterField;
